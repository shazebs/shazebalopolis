...
export class FetchDataComponent {
  ...
  async GetAllTweets(): Promise<Observable<Tweet[]>> {
    return this.http.get<Tweet[]>(`${this.url}/tweets`, { headers: new HttpHeaders().set('Authorization', 'Bearer ' + this.getToken()) });
  }
  ...
  CreateNewTweet(entity: Tweet): Observable<Tweet> {
    return this.http.post<Tweet>(`${this.url}/tweets`, entity, { headers: new HttpHeaders().set('Authorization', 'Bearer ' + this.getToken()) });
  }
}
